...
const ibili = (function () {
  return {
    ...
    getSearchBypage: function (content, page) {
      var page = page || 1;
      var ul =
        'https://api.bilibili.com/x/web-interface/search/all/v2?context=&page=' +
        page +
        '&order=&keyword=' +
        content +
        '&duraton=&tids_1=&tids_2=&__refresh__=true&__reload__=false&highlight=1&single_column=0&jsonp=jsonp';
